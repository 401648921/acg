<template>
  <div class="list-content">
    <div class="list-title">
      <span class="list-cab active">关注</span>
      <span class="list-cab" @click="go('/home/personIndex/fansList')">粉丝</span>
    </div>
    ...
    <el-empty v-show="list.length == 0" description="暂无关注"></el-empty>
  </div>
</template>
    ...
    save(cnt,page){
      this.$userRequest({
          ...
          params: {
           ...
           this.list = this.list.concat(res.data.data.followList)
        }).catch(e=>{
