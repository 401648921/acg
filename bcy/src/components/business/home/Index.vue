<template>
  <div class="page-list">
    <div class="midder-part">
      ...
      <span class="page-element active">发现</span>
      <span class="page-element" @click="go('/home/questionResList')">问答</span>
  ...
  <div class="content-box-part">
    <div ref="element1" class="content-box-list">
      <div v-for="item in list1" :key="item" class="content-box-element">
        <card :number="item.number" :id="item.id" :username="item.username" :photo="item.photo" :description="item.description" :label="item.label" :cosPhoto="item.cosPhoto" :createTime="item.createTime"></card>
      </div>
    </div>
    <div ref="element2" class="content-box-list">
      <div  v-for="item in list2" :key="item" class="content-box-element">
        <card :number="item.number" :id="item.id" :username="item.username" :photo="item.photo" :description="item.description" :label="item.label" :cosPhoto="item.cosPhoto" :createTime="item.createTime"></card>
      </div>
    </div>
